...
trait JsonSupport extends SprayJsonSupport with DefaultJsonProtocol {
  ...
  implicit val jwtFormat: RootJsonFormat[Jwt] = jsonFormat1(Jwt)
  implicit val jwtReqFormat: RootJsonFormat[JwtRequest] = jsonFormat2(JwtRequest)

  implicit val keyFormat: RootJsonFormat[Key] = jsonFormat8(Key)
  implicit val keyReqFormat: RootJsonFormat[KeyRequest] = jsonFormat3(
    KeyRequest)
